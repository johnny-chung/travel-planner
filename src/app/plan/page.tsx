...
import PlanPageClient from "@/components/trips/PlanPageClient";
...
export default async function PlanPage() {
  ...
  return <PlanPageClient initialTrips={serialized} googleMapsApiKey={process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY ?? ""} />;
}
